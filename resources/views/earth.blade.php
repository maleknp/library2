...
@section('content')
 ...
 <section id="hello" class="contact-banner bg-mega" style="background: url(images/earth.png)no-repeat;">
        <div class="overlay"></div>
            <div class="container">
                <div class="row">
                     <div class="main_home text-center">
                        <div class="contact_text">
                              <h1 class="text-white text-uppercase" style="margin-bottom: -200px;">{{trans('main.es')}}</h1>
                       </div>
                </div>
             </div><!--End off row-->
            ...
            <div class="row" style="margin-top: -100px;">
               <h4 class="text-black text-uppercase text-center" style="padding-bottom: 20px;">{{trans('main.sections')}}</h4>
                <div class="col-sm-6 col-md-6 col-lg-4 element-animate ">
                    <a href="{{ route('material',['id'=>14]) }}" class="img-bg" style="background-image: url('{{ asset('/images/amaa.jpg') }}')">
                        <div class="text">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 element-animate ">
                    <a href="{{ route('material',['id'=>12]) }}" class="img-bg" style="background-image: url('{{ asset('/images/ge.jpg') }}')">
                        <div class="text">
                            <h2>{{trans('main.gs')}}</h2>
                            <p style="color: #fff;">{{trans('main.click-material')}}</p>
                        </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 element-animate ">
                    <a href="{{ route('material',['id'=>13]) }}" class="img-bg" style="background-image: url('{{ asset('/images/gp.jpg') }}')">
                        <div class="text">
                            <span class="icon ion-ios-location"></span>
                            <h2>{{trans('main.gps')}}</h2>
                            <p style="color: #fff;">{{trans('main.click-material')}}</p>
                        </div>
                    </a>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-7 col-sm-12 col-xs-12 text-right pull-right sm-text-center">
                                <div class="work_item_img">
                                    <img src="{{ asset('/images/ge300.jpg') }}" alt="" />
                                </div>
                            </div>
