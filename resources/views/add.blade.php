...
@section('content')
    ...
    <div class="bg-contact100" style="background-image: url('images/222.jpg');">
        <div class="container-contact100">
            <div class="wrap-contact100">
                ...
                <form action="  {{ url('/new') }} " method="post" enctype="multipart/form-data" class="contact100-form validate-form">
                 @csrf
...
@endif
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Extension Type is required">
                        <select style="padding: 13px; padding-left: 40px; border-radius: 20px 20px 20px 20px;" class="input100" name="type">
                            <option  value="0">Add Type</option>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Course Code is required">
                        <input class="input100" type="text" name="code" placeholder="Course Code Ex:- CS111">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Course Code is required">
                        <input class="input100" type="text" name="name" placeholder="Name of Sheet,Book or Test">
                        <span class="focus-input100"></span>
                        <span class="symbol-input100">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="pdf or image is required">
